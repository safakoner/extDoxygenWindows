...
# DESCRIPTION
# ----------------------------------------------------------------------------------------------------
## @file    extDoxygenWindows/packageEnvLib.py @brief [ FILE   ] - Package environment module.
## @package extDoxygenWindows.packageEnvLib    @brief [ MODULE ] - Package environment module.
